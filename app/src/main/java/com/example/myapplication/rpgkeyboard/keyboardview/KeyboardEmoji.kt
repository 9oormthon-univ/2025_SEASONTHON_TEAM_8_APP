package com.example.myapplication.rpgkeyboard.keyboardview
...
import com.example.myapplication.rpgkeyboard.*
...
class KeyboardEmoji{
    companion object{
        ...
        val fourthLineText = listOf<String>("🌐",getEmojiByUnicode(0x1F600), getEmojiByUnicode(0x1F466), getEmojiByUnicode(0x1F91A), getEmojiByUnicode(0x1F423),getEmojiByUnicode(0x1F331), getEmojiByUnicode(0x1F682),"DEL")
        var vibrate = 0
        var sound = 0
