...
class SpellCheckManager(private val context: Context) {
                ...
                LinearLayout(context).apply {
                    ...
                    layoutParams =
                            LayoutParams(
                                    ...
                                    .apply { setMargins(0, ERROR_MARGIN_DP, 0, ERROR_MARGIN_DP) }
                }
                ...
                Button(context).apply {
                    ...
                    layoutParams =
                            LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT)
                                    .apply { height = (BUTTON_HEIGHT_DP * 0.7f).dp() }
                    setOnClickListener { inputConnection?.commitText(error.corrected, 1) }
                    setPadding(
    ...
    private fun getSpellErrors(text: String): List<SpellError> {
        ...
        return listOf(SpellError("맞춤법", "맞춤법", "맞춤법"), SpellError("검사", "검사", "검사"))
    }
    ...
    /** 맞춤법 오류 데이터 클래스 */
    data class SpellError(val original: String, val corrected: String, val description: String)
}
